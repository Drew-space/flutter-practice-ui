...
//                                     MaterialPageRoute(
//                                       builder: (_) =>
//                                           VidsrcPlayerPage(movie: widget.movie),
//                                     ),
//                                   );
//                                 },
//                               ),
...
class _MovieDetailPageState extends State<MovieDetailPage> {
  ...
  void _goToPlayer() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => VidsrcPlayerPage(
          movie: widget.movie,
          season: widget.movie['_currentSeason'] ?? 1,
          episode: widget.movie['_currentEpisode'] ?? 1,
        ),
      ),
    );
  }
          ...
          SliverToBoxAdapter(
            child: Stack(
              ...
              children: [
                ...
                // Center play button - NOW CLICKABLE
                Positioned(
                  top: size.height * 0.18,
                  left: 0,
                  right: 0,
                  child: Center(child: _PlayButton(onTap: _goToPlayer)),
                ),
                Positioned(
                  bottom: -40,
                  left: 0,
