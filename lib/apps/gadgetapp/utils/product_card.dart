...
//   @override
//   Widget build(BuildContext context, wid) {
...
/// and the Popular Products 2-column grid.
///
/// NOTE: This does NOT watch gadgetProvider itself. The parent widget
/// (GadgetProducts) already watches the provider and passes ONE
/// product down to each card. That's why this is a plain
/// StatelessWidget, not a ConsumerWidget.
